function dy = gif1_dy(t, y, params)
%% Initialization
dy = zeros(17, 1);
...
% CEI
WOX5_cei = y(6); SHR_cei = y(7); AN3_cei = y(8); SCR_cei = y(9);
...
d_3_qc = params(8); d_8_qc = params(9); d_12_qc = params(10);
...
d_11_cei = params(21); d_12_cei = params(22);
...
d_3_endo = params(32); d_8_endo = params(33); d_12_endo = params(34);
...
dy(2) = (a_qc * SHR_vasc) - (d_12_qc * SHR_qc); % SHR_qc
...
% CEI
dy(6) = (b_qc * WOX5_qc) - (d_11_cei * WOX5_cei); % WOX5_cei
dy(7) = (a_qc * SHR_vasc) - (d_12_cei * SHR_cei); % SHR_cei

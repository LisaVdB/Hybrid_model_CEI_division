...
function dy = gif1_dy_est_mutant(t, y, params)
%% Initialization
dy = zeros(size(y, 1), 1);
...
% CEI
X = y(6); SHR_cei = y(7); AN3_cei = y(8); SCR_cei = y(9);
...
d_8_endo = 45.4204051;
d_1_vasc = 397.0117125;
d_4_endo = 109.0219895;
d_4_qc = 259.9675969;
k_4_vasc = 6850.56995;
d_4_vasc = 12.26685298;
d_4_cei = 130.8429372;
d_8_cei = 0.883631329;

% Fitted to time course data
k_1_qc = params(7);
k_2_cei = params(8); k_2_qc = k_2_cei; k_2_endo = k_2_cei;
...
d_3_qc = 1; d_8_qc = 0.5;
k_5_cei = 25000; k_8_cei = 5;
K_D2_cei = 500; K_D3_cei = 600; K_D4_cei = 1000;
K_D6_cei = 0.002; % New regulation
d_3_cei = 0.5;
K_D1_vasc = 3;
k_8_endo = 5;
K_D3_endo = 600; K_D4_endo = 1000;
...
% CEI
dy(6) = k_6_cei * (AN3_cei / (K_D2_cei + AN3_cei)) - (d_6_cei * X); % X
...
dy(9) = k_3_cei * ((K_D4_cei * SCR_cei + SSC_cei) /...
    ...
    K_D4_cei * SCR_cei + SSC_cei)) - (d_3_cei * SCR_cei); % SCR_cei
...
dy(11) = k_5_cei * ((SSC_cei / (K_D3_cei * K_D4_cei...
    ...
    + SSC_cei)) + (K_D6_cei / (K_D6_cei + X))) - (d_5_cei * CYCD6_cei); % CYCD6_cei
...
dy(16) = k_3_endo * ((K_D4_endo * SCR_endo + SSC_endo) /...
    ...
    K_D4_endo * SCR_endo + SSC_endo)) - (d_3_endo * SCR_endo); % SCR_endo
